...
//       For 5f, replace parseHighlightLines with parseHighlightText

/**Creates an instance of ColorList with makeColorTree */
...
try {
  ...
  if (word !== null) {
    root.render(<React.StrictMode><ShowColors text={word} colors={colorList}/></React.StrictMode>);
  ...
  // If the query included a list of lines, then show them highlighted.
    ...
    root.render(
        <React.StrictMode>
          <ShowHighlights highlights={highlights} colors={colorList}/>
        </React.StrictMode>);
