 ...
 * @param props Contains a text field with the text to look for in color names and colors field with a list of colors to search on
 ...
 * @param props Contains a highlights field that has a list of highlights to show and a colors field with a list of colors to search on
