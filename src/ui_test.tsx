...
describe('ui', function() {
  ...
  it('ShowColors', function() {
    assert.deepEqual(
        ShowColors({text: 'pretendo', colors: colorList}), <div>{[]}</div>);
    assert.deepEqual(
        ShowColors({text: 'indigo', colors: colorList}),
        <div>{[
    ...
    assert.deepEqual(
        ShowColors({text: 'lavender', colors: colorList}),
        <div>{[
  ...
  it('ShowHighlights', function() {
    assert.deepEqual(
        ShowHighlights({highlights: explode_array([]), colors: colorList}),
        <div>{[]}</div>);
    assert.deepEqual(
